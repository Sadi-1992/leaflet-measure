  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      e.replace(C, function(t, r, n, o, i, s) {
        ...
        (E += "';\n");
      var S = x.call(t, 'variable') && t.variable;
      S || (E = 'with (obj) {\n' + E + '\n}\n'),
        (E = (M ? E.replace(m, '') : E).replace(y, '$1').replace(v, '$1;')),
        (E =
          'function(' +
          (S || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var D = i(function() {
        return Function(L, A + 'return ' + E).apply(void 0, O);
      });
