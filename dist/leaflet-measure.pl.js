  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var j,
        ...
        S = w.call(t, 'sourceURL')
          ? '//# sourceURL=' + (t.sourceURL + '').replace(/[\r\n]/g, ' ') + '\n'
          : '';
      e.replace(C, function(t, r, o, n, i, s) {
        return (
          o || (o = n),
          (E += e.slice(L, s).replace(_, u)),
          r && ((j = !0), (E += "' +\n__e(" + r + ") +\n'")),
          i && ((x = !0), (E += "';\n" + i + ";\n__p += '")),
          o && (E += "' +\n((__t = (" + o + ")) == null ? '' : __t) +\n'"),
          (L = s + t.length),
        ...
        (E += "';\n");
      var A = w.call(t, 'variable') && t.variable;
      A || (E = 'with (obj) {\n' + E + '\n}\n'),
        (E = (x ? E.replace(m, '') : E).replace(y, '$1').replace(v, '$1;')),
        (E =
          'function(' +
          (A || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var D = i(function() {
        return Function(k, S + 'return ' + E).apply(void 0, O);
      });
